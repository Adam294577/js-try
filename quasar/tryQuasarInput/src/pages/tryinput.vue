<template>
  <q-page class="">
    ...
    <div class="h-[50px] border-2 border-red-600 pt-2">
      <span>item1</span>
      <input type="checkbox" v-model="SelectEditItem[0].statusF" @click="handStatusF('adam')">
      X
      <input type="checkbox" v-model="SelectEditItem[0].statusT" @click="handStatusT('adam')">
      V
      <input
    ...
    <div class="h-[50px] border-2 border-red-600 pt-2">
      <span>item2</span>
      <input type="checkbox" v-model="SelectEditItem[1].statusF" @click="handStatusF('adam2')">
      X
      <input type="checkbox" v-model="SelectEditItem[1].statusT" @click="handStatusT('adam2')">
      V
      <input
